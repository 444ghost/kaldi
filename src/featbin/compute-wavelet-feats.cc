...
int main(int argc, char *argv[]) {
	...
	ParseOptions po("444ghost.ERROR in compute-wavelet-feats.cc: Invalid options for initializing ParseOptions ");
	...
	if (output_format == "kaldi") {
		...
		KALDI_ERR << "444ghost.ERROR in compute-wavelet-feats.cc: output_format is not \"kaldi\"";
	}
